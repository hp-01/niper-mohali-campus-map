    ...
    <div className="app-container">
      ...
      <div className="main-content">
              ...
              <React.Fragment key={polygon.id}>
                ...
                {activePolygonId === polygon.id && (
                  <InfoWindow
                    ...
                    options={{ maxWidth: 280 }} // This is still a good idea
                  >
                    <div>
        ...
        {activePolygonId &&
          <div>
            {/* 
        This is where the rest of your UI goes.
        It can be a map, a form, a dashboard, etc. 
        It will scroll normally behind the button.
      */}
            <div style={{ height: "200vh", background: "#eee", padding: "1rem" }}>
              <h1>Your Page Content</h1>
              <p>Scroll down to see the button stay in place.</p>
            </div>


            {/* 2. Add the floating button container here */}
