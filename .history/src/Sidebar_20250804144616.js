  ...
  return (
    <aside className="sidebar">
      ...
      <ul className="results-list">
        ...
        <li><button className='btn' style={{ background: "#007bff", width: "100%", borderRadius: 0 }} onClick={() => navigator.clipboard.writeText(localStorage.getItem('niper-mapped-areas'))}>Copy All</button></li>
      </ul>
    </aside>
  );
}
